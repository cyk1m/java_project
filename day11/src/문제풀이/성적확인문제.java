...
public class 성적확인문제 {
	...
	public static void main(String[] args) {
		...
		// 성적이 동일한 과목이 없을 때 발생하는 에러를 해결해주는 방법(else 추가)
		if (location != -1) {
...
// 이 코드엔 문제점이 하나 더 있는데, System.out.println(subject[location]);
// 그냥 이렇게 출력하면 발생하는 문제: 동일한 과목이 2개가 됐을 때
// line 25에서 두 번째로 걸리는 값(i)이 첫번째(i)를 덮어쓴다. 
// 그래서 결과적으로는 한 과목만 출력되는 문제가 생긴다.
